...
- 0 MB, this is beacuse the Number of records is in metadata form in the non-partitioned/materialed table, therefore BigQuery does not need to go through, read and process them.
